//This is the design pattern Singelton
class SortingArray {
...
//This is the design pattern Singelton
  static getInstance(arrayBarSizes, arrayDivElements, arraySize, arraySection) {
    if (!SortingArray._instance) {
      this.instance = new SortingArray(arrayBarSizes, arrayDivElements, arraySize, arraySection);
    }
